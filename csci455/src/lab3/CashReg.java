...
{
	purchase = purchase + (Math.round(amount*100));
}
...
{
   payment = (double)(dollars*100 + quarters * QUARTER_VALUE + dimes * DIME_VALUE
...
//}
	...
	public void giveChange() {
		double change = ((double)payment - purchase);
		   int dollarnum = (int)change/100;
		   int quarternum = (int)(change-(double)dollarnum*100)/25;
		   int dimenum = (int)(change-(double)(quarternum*25)-(double)(dollarnum*100))/10;
		   int nickelnum = (int)(change-(double)(quarternum*25)-(double)(dollarnum*100)-(double)(dimenum*10))/5;
		   int Penniesnum = (int)(change-(double)(quarternum*25)-(double)(dollarnum*100)-(double)(dimenum*10)-(double)(nickelnum*5));
		   
		   Change changeReturn = new Change(dollarnum, quarternum, dimenum, nickelnum, Penniesnum);
		   System.out.println(changeReturn.toString());
		   dollarnum = 0;
		   quarternum = 0;
		   dimenum = 0;
		   nickelnum = 0;
